...
but it overwhelmingly treats the planning layers separately, in the
tradition of service network design \cite{crainic2000}: flight scheduling,
fleet assignment, routing, each with its own models. The integrated
formulation of \cite{derigs2013} is, to our knowledge, still the reference
point for joint optimization of all four layers over a cyclic week, and no
published computational study takes it --- or any comparable integrated
model --- to integrator scale, nor removes the planner-written candidate
list it presupposes. Those are the two gaps this paper addresses.

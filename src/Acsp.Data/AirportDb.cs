...
public static class AirportDb
{
    public static readonly IReadOnlyList<AirportInfo> All = Parse("""
        ...
        SIN|Singapore|1.35|103.99|Asia
        BKK|Bangkok|13.68|100.75|Asia
        HKT|Phuket|8.11|98.32|Asia
        ...
        PNH|Phnom Penh|11.55|104.84|Asia
        RGN|Yangon|16.91|96.13|Asia
        DAC|Dhaka|23.84|90.40|Asia
        CCU|Kolkata|22.65|88.45|Asia
        MAA|Chennai|12.99|80.17|Asia
        BLR|Bengaluru|13.20|77.71|Asia
        HYD|Hyderabad|17.23|78.43|Asia
        BOM|Mumbai|19.09|72.87|Asia
        DEL|Delhi|28.56|77.10|Asia
        CMB|Colombo|7.18|79.88|Asia
        KHI|Karachi|24.91|67.16|Asia
        LHE|Lahore|31.52|74.40|Asia
        ICN|Seoul Incheon|37.47|126.45|Asia
        PUS|Busan|35.18|128.94|Asia
        NRT|Tokyo Narita|35.77|140.39|Asia
        KIX|Osaka Kansai|34.43|135.24|Asia
        NGO|Nagoya|34.86|136.80|Asia
        FUK|Fukuoka|33.59|130.45|Asia
        CTS|Sapporo|42.77|141.69|Asia
        PVG|Shanghai Pudong|31.14|121.81|Asia
        PEK|Beijing|40.08|116.60|Asia
        CAN|Guangzhou|23.39|113.30|Asia
        SZX|Shenzhen|22.64|113.80|Asia
        XMN|Xiamen|24.54|118.13|Asia
        TAO|Qingdao|36.36|120.09|Asia
        CTU|Chengdu|30.56|103.95|Asia
        CKG|Chongqing|29.71|106.65|Asia
        WUH|Wuhan|30.77|114.21|Asia
        TSN|Tianjin|39.12|117.35|Asia
        DLC|Dalian|38.97|121.54|Asia
        HGH|Hangzhou|30.24|120.43|Asia
        NKG|Nanjing|31.74|118.87|Asia
        ...
        STR|Stuttgart|48.69|9.22|Europe
        NUE|Nuremberg|49.50|11.08|Europe
        LEJ|Leipzig|51.42|12.23|Europe
        ...
        BUD|Budapest|47.43|19.26|Europe
        OTP|Bucharest|44.57|26.10|Europe
        SOF|Sofia|42.70|23.42|Europe
        ...
        IST|Istanbul|41.27|28.73|Europe
        ESB|Ankara|40.13|33.00|Europe
        CPH|Copenhagen|55.62|12.66|Europe
        BLL|Billund|55.74|9.16|Europe
        ARN|Stockholm|59.65|17.93|Europe
        ...
        KBP|Kyiv|50.35|30.89|Europe
        SVO|Moscow SVO|55.98|37.41|Europe
        LED|St Petersburg|59.80|30.26|Europe
        LYS|Lyon|45.73|5.09|Europe
        MRS|Marseille|43.44|5.21|Europe
        TLS|Toulouse|43.63|1.36|Europe
        NCE|Nice|43.66|7.22|Europe
        LIL|Lille|50.57|3.10|Europe
        ...
        PHX|Phoenix|33.44|-112.01|NorthAmerica
        ...
        DXB|Dubai|25.25|55.37|MiddleEast
        AUH|Abu Dhabi|24.44|54.65|MiddleEast
        SHJ|Sharjah|25.33|55.52|MiddleEast
        DOH|Doha|25.27|51.61|MiddleEast
        BAH|Bahrain|26.27|50.64|MiddleEast
        KWI|Kuwait City|29.22|47.97|MiddleEast
        RUH|Riyadh|24.96|46.70|MiddleEast
        JED|Jeddah|21.68|39.16|MiddleEast
        DMM|Dammam|26.47|49.80|MiddleEast
        MCT|Muscat|23.60|58.29|MiddleEast
